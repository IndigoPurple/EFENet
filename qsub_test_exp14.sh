...
#block(name=exp14_test, threads=5, memory=5000, subtasks=1, gpu=true, hours=100)
...
--optim Adam \
--lr 0.00001  \
--checkpoints_dir ./checkpoints_exp14_test/ \
--frame_num 7 \
--checkpoint_file ./checkpoints_exp14/CP150000.pth \
--with_GAN_loss 1 \
--img_save_path result/exp14_test \
--net_type multiflow2 \
--pretrained 0 \
--gpu_id 0
    echo "Done" 
