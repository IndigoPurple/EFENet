...
#block(name=exp17_test, threads=5, memory=5000, subtasks=1, gpu=true, hours=100)
...
--optim Adam \
--lr 0.00001  \
--checkpoints_dir ./checkpoints_exp17_test/ \
--frame_num 7 \
--checkpoint_file ./checkpoints_exp17/CP240000.pth \
--with_GAN_loss 1 \
--img_save_path result/exp17_test \
