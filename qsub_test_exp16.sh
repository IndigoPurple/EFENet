...
#block(name=exp16_test, threads=5, memory=5000, subtasks=1, gpu=true, hours=100)
...
--optim Adam \
--lr 0.00001  \
--checkpoints_dir ./checkpoints_exp16_test/ \
--frame_num 41 \
--checkpoint_file ./checkpoints_exp16/CP240000.pth \
--with_GAN_loss 1 \
--img_save_path result/exp16_test \
--net_type multiflowfusion3 \
--pretrained 0 \
--gpu_id 0
    echo "Done" 
